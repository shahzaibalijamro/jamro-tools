...
export function ToolsCtaSection() {
  return (
    <section className="mt-[48px] p-[48px] rounded-2xl bg-[#e7eeff] dark:bg-surface-container flex flex-col md:flex-row items-center justify-between gap-[24px] overflow-hidden">
      <div className="relative z-10 max-w-lg">
        <h2 className="text-headline-md text-[#111c2d] dark:text-on-surface mb-[8px]">
         Can't find a specific tool?
       </h2>
        <p className="text-body-md text-[#434655] dark:text-on-surface-variant max-w-lg">
         We're constantly adding new utilities to our ecosystem. Let
         us know what you're looking for and we'll build it for
         the community.
       </p>
        <button className="mt-[24px] px-[48px] py-[16px] bg-[#004ac6] text-white rounded-full text-label-md font-bold hover:shadow-[0_10px_24px_rgba(0,74,198,0.18)] transition-all active:scale-95 cursor-pointer">
         Submit Tool Request
       </button>
     </div>
