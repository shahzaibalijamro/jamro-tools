...
import { simulateCreditCardPayoff, type CreditCard as Card, type PayoffResult as Result } from "../logic/credit-card-payoff-calculator";
...
export default function CreditCardPayoffCalculator() {
  ...
  const results = useMemo(() => ({ minimum: simulateCreditCardPayoff(cards, Math.max(25, totalBalance * 0.02), "minimum"), avalanche: simulateCreditCardPayoff(cards, monthlyPayment, "avalanche"), snowball: simulateCreditCardPayoff(cards, monthlyPayment, "snowball") }), [cards, monthlyPayment, totalBalance]);
