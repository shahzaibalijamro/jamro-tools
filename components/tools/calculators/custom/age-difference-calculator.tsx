    ...
    <>
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-[24px] mb-[48px]">
        ...
        <aside className="lg:col-span-4 space-y-[24px]">
          ...
          {/* Contextual Hint */}
          <div
            className="rounded-xl p-[16px] flex gap-[8px] items-start"
            style={{
              background: "var(--color-secondary-fixed, #d8e2ff)",
              color: "var(--color-on-secondary-fixed, #001a42)",
            }}
          >
          ...
          >
            ...
            <div className="w-full mt-auto pt-[24px] border-t border-outline-variant grid grid-cols-2 gap-[16px] relative z-10">
              <div className="bg-[#f0f3ff] p-[16px] rounded-xl flex flex-col items-center border border-[#c3c6d6]/30">
                <span className="text-[12px] leading-[1.4] text-[#737685] uppercase">Precision</span>
                <span className="text-[20px] leading-[1.4] font-semibold text-on-surface">High</span>
              </div>
              <div className="bg-[#f0f3ff] p-[16px] rounded-xl flex flex-col items-center border border-[#c3c6d6]/30">
                <span className="text-[12px] leading-[1.4] text-[#737685] uppercase">Calendar</span>
