  ...
  return (
    <article className="mt-6 space-y-6 px-4 pb-12 sm:px-6 md:py-0">
      ...
      <section id="tool-accuracy-disclaimer" className="scroll-mt-24 md:scroll-mt-20">
        ...
        <div className="mb-4 rounded-lg border-l-4 border-[#943700] bg-[#dee8ff] p-6">
          <p className="text-[16px] leading-[1.6] text-[#434655]">
      ...
      <section id="limitation-of-liability" className="scroll-mt-24 md:scroll-mt-20">
        ...
        <div className="mb-4 rounded-lg border-l-4 border-[#ffdad6] bg-[#fff5f4] p-6">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-6 text-[16px] leading-[1.6] text-[#434655]">
      ...
      <section id="contact-information" className="scroll-mt-24 md:scroll-mt-20">
        ...
        <div className="space-y-4 text-[16px] leading-[1.6] text-[#434655]">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <div className="flex flex-1 items-center gap-4 rounded-lg bg-[#e7eeff] p-4">
              <Icon name="mail" className="text-[#004ac6]" />
            ...
            <Link
              href="/contact"
              className="flex flex-1 items-center gap-4 rounded-lg bg-[#e7eeff] p-4 transition-colors hover:bg-[#dee8ff]"
            >
