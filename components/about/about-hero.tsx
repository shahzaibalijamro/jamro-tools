...
export function AboutHero() {
  return (
    <section className="mb-12 md:grid md:grid-cols-2 md:items-center md:gap-12">
      ...
      <div>
        <span className="mb-4 inline-flex items-center gap-1 rounded-full bg-[#dbe1ff]/80 px-4 py-1 text-[14px] font-semibold leading-[1.4] tracking-[0.01em] text-[#00174b]">
          Our Journey
        </span>
        <h1 className="mb-2 text-[32px] font-semibold leading-[1.2] tracking-[-0.01em] text-[#111c2d] md:text-[48px] md:leading-[1.1] md:tracking-[-0.02em]">
          Tools for the Modern Creator.
        </h1>
        <p className="max-w-sm text-[16px] leading-[1.6] text-[#434655] md:max-w-xl md:text-[18px]">
          ...
          {missionFacts.map((fact) => (
            <div key={fact} className="flex items-center gap-2">
              <CheckCircle2
                ...
                aria-hidden="true"
              />
              <span className="text-[14px] font-semibold leading-[1.4] tracking-[0.01em] text-[#111c2d]">
                {fact}
              </span>
            </div>
          ))}
