  ...
  return (
    <article className="space-y-6 mt-6 px-4 pb-12 sm:px-6 md:py-0">
      ...
      <section id="introduction" className="scroll-mt-24 md:scroll-mt-20">
        ...
        <h2 className="mb-4 flex items-center gap-1 text-[20px] font-semibold leading-[1.4] text-[#111c2d] md:hidden">
      ...
      <section id="information-we-collect" className="scroll-mt-24 md:scroll-mt-20">
        ...
        <div className="space-y-6 text-[16px] leading-[1.6] text-[#434655]">
          <div>
            <h3 className="mb-2 text-[18px] font-semibold leading-[1.4] text-[#111c2d]">Information You Provide</h3>
          ...
          <div>
            <h3 className="mb-2 text-[18px] font-semibold leading-[1.4] text-[#111c2d]">Automatically Collected Information</h3>
      ...
      <div className="my-12 flex items-center justify-center overflow-hidden rounded-xl bg-[#dee8ff] h-48 md:h-64">
      ...
      <section id="contact-us" className="scroll-mt-24 md:scroll-mt-20">
        ...
        <div className="space-y-4 text-[16px] leading-[1.6] text-[#434655]">
          ...
          <div className="rounded-xl border border-[#004ac6]/20 bg-[#f0f3ff] p-6 text-[16px] leading-[1.6] text-[#434655]">
